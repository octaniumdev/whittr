...
app.get("/chat", function (req, res) {
    fs.createReadStream("./public/chat.html").pipe(res);
});
...
app.get("/join", function (req, res) {
    fs.createReadStream("./public/join.html").pipe(res);
});

app.get("/rules", function (req, res) {
    fs.createReadStream("./public/rules.html").pipe(res);
});

app.get("/tos", function (req, res) {
    fs.createReadStream("./public/tos.html").pipe(res);
});

app.get("/js/chat.js", function (req, res) {
    fs.createReadStream("./public/js/chat.js").pipe(res);
});

app.get("/js/libs/deparam.js", function (req, res) {
    fs.createReadStream("./public/js/libs/deparam.js").pipe(res);
});
app.get("/js/libs/jquery-3.1.0.min.js", function (req, res) {
    fs.createReadStream("./public/js/libs/jquery-3.1.0.min.js").pipe(res);
});

app.get("/js/libs/moment.js", function (req, res) {
    fs.createReadStream("./public/js/libs/moment.js").pipe(res);
});

app.get("/js/libs/mustache.js", function (req, res) {
    fs.createReadStream("./public/js/libs/mustache.js").pipe(res);
});

app.get("/css/style.css", function (req, res) {
    fs.createReadStream("./public/css/style.css").pipe(res);
});

app.get("/css/chat.css", function (req, res) {
    fs.createReadStream("./public/css/chat.css").pipe(res);
});

app.get("/assets/icon.png", function (req, res) {
    fs.createReadStream("./public/assets/icon.png").pipe(res);
});
